...
const allProfiles = [
  /* ================= WOMEN ================= */
  {
    ...
    bio: "Love deep conversations & romantic evenings.",
  },
  {
    id: 2,
    name: "Emily",
    ...
    bio: "Creative soul 🎨 | Coffee over clubs.",
  },
  {
    id: 3,
    name: "Olivia",
    ...
    bio: "Travel addict ✈️ | Sunset lover.",
  },
  {
    id: 4,
    name: "Ava",
  ...
  },
  {
    ...
    bio: "Introvert but fun once comfortable.",
  },
  {
    id: 6,
    name: "Charlotte",
    ...
    bio: "Looking for real chemistry 💕",
  },
  {
    id: 7,
    name: "Amelia",
  ...
  },
  {
    ...
    age: 24,
    gender: "woman",
    img: "https://i.pravatar.cc/400?img=19",
    bio: "Nature lover 🌿",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    bio: "Meaningful connections only.",
  },
  {
    id: 11,
    name: "Lily",
  ...
  },
  {
    ...
    age: 25,
    gender: "woman",
    img: "https://i.pravatar.cc/400?img=23",
    bio: "Late-night talks hit different.",
  },
  ...
  /* ================= MEN ================= */
  {
    ...
    bio: "Fitness lover • Honest vibes.",
  },
  {
    id: 17,
    name: "Ryan",
  ...
  },
  {
    ...
    age: 27,
    gender: "man",
    img: "https://i.pravatar.cc/400?img=55",
    bio: "Calm, caring & honest.",
  },
  {
    id: 30,
    name: "Theo",
  ...
  },
  {
    ...
    age: 70,
    gender: "everyone",
    img: "https://i.pravatar.cc/400?img=63",
    bio: "Good conversations win.",
  },
  {
    id: 35,
    name: "Morgan",
...
const Explore = () => {
  ...
  const handleLike = async (profile) => {
    if (liked.includes(profile.id)) {
      ...
      try {
        await api.post("/likes", { toUserId: profile.id });
        console.log(`Liked user ${profile.name}`);
      } catch (error) {
