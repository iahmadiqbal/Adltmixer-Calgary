...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-24 md:pt-28 lg:pt-32 pb-8 px-4 sm:px-6 md:px-8 lg:px-12 relative overflow-hidden">
